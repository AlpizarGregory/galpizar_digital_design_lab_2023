...
vcom -93 -work work {C:/intelFPGA_lite/galpizar_digital_design_lab_2023/Exp1/sumador_4bits.vhd}

vcom -93 -work work {C:/intelFPGA_lite/galpizar_digital_design_lab_2023/Exp1/sumador_4bits_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  sumador_4bits_tb
